...
SVC_NAME="actions.runner.Djai284-learn-continuous-integration.Dhananjais-MacBook-Air"
SVC_NAME=${SVC_NAME// /_}
SVC_DESCRIPTION="GitHub Actions Runner (Djai284-learn-continuous-integration.Dhananjais-MacBook-Air)"
